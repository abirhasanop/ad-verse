...
const Footer = () => {
    return (
        <div className='mt-20'>
            <footer className="text-center lg:text-left bg-orange-100 text-gray-600">
          ...
          ">
                            ...
                            <p>
                                Adverse provides you best 2nd product buy sell Platform in market. Weather its Xiaomi or Iphone. Adverse is always there for you
                            </p>
                        </div>
                        <div className="">
                            ...
                            <p className="mb-4">
                                <Link className="text-gray-600">Xiamo</Link>
                            </p>
                            <p className="mb-4">
                                <Link className="text-gray-600">Samsung</Link>
                            </p>
                            <p className="mb-4">
                                <Link className="text-gray-600">Iphose</Link>
                            </p>
                            {/* <p>
                        ...
                        <div className="">
                            ...
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Vivo</a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">Oppo
                                </a>
                            </p>
                            <p className="mb-4">
                                <a href="#!" className="text-gray-600">One Plus
                                </a>
                            </p>
                            <p>
                                <a href="#!" className="text-gray-600">Realme</a>
                            </p>
                        </div>
                        <div className="">
                            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                ...
                <div className="text-center p-6 bg-orange-200">
                    ...
                    <a className="text-gray-600 font-semibold" href="#_">Ad Verse</a>
                </div>
            </footer>
        </div>
    );
